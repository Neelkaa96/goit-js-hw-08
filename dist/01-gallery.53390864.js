...
[
    ...(0, _galleryItems.galleryItems)
].forEach((photo)=>{
    let galleryItem = document.createElement("a");
    galleryItem.classList.add("gallery__item");
    galleryItem.setAttribute("href", `${photo.original}`);
    galleryItem.insertAdjacentHTML("afterbegin", `<img class="gallery__image" src="${photo.preview}" data-source="${photo.original}" alt="${photo.description}">`);
